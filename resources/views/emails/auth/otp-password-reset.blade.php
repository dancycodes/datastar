...
<head>
    ...
    <title>{{ __('Password Reset Code - DancyDeals') }}</title>
</head>
...
{{--                            <img src="{{ Storage::url('images/logo.png') }}" alt="{{ __('DancyDeals') }}" style="width: 120px; height: auto;">--}}
{{--                        </div>--}}

                        <!-- Header -->
                        <div style="text-align: center; margin-bottom: 24px;">
                            <h1 style="margin: 0; font-size: 24px; color: #222E50; font-weight: bold; margin-bottom: 8px;">{{ __('Password Reset Request') }}</h1>
                        ...
                        <div style="text-align: center; margin-bottom: 32px;">
                            <p style="margin: 0 0 24px 0; color: #6B7280; font-size: 16px; line-height: 24px;">
                                {{ __('We received a request to reset your DancyDeals account password. Use the verification code below to proceed:') }}
                            </p>
                            ...
                            <div style="margin-bottom: 24px;">
                                <p style="margin: 0 0 16px 0; color: #6B7280; font-size: 14px; line-height: 20px;">
                                    {{ __('Enter this code on the password reset page to continue.') }}
                                </p>
                            ...
                            <div style="background-color: #fef3cd; border: 1px solid #fbbf24; border-radius: 6px; padding: 16px; margin-bottom: 24px;">
                                <p style="margin: 0; color: #92400e; font-size: 14px; line-height: 20px;">
                                    ...
                                    {{ __('If you didn\'t request this password reset, please ignore this email. Your account remains secure.') }}
                                </p>
                            </div>
                        ...
                        <div style="text-align: center; border-top: 1px solid #E5E7EB; margin-top: 24px; padding-top: 24px;">
                            <p style="margin: 0; color: #6B7280; font-size: 14px;">
                                ...
                                <a href="mailto:support@dancydeals.com"
                                   style="color: #222E50; text-decoration: none; border-bottom: 1px solid #222E50;">
                                    {{ __('DancyDeals Support') }}
                                </a>
                            </p>
                            <p style="margin: 8px 0 0 0; color: #9CA3AF; font-size: 12px;">
                                {{ __('© :year DancyDeals. All rights reserved.', ['year' => date('Y')]) }}
                            </p>
                        </div>
                    </td>
                </tr>
